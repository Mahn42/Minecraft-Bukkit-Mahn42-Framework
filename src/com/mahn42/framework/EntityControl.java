...
public class EntityControl {
    ...
    public void run() {
        ...
        if (pathItem != null) {
            ...
            if (pathItem != null && lDest != null) {
                net.minecraft.server.v1_6_R2.Entity lMCEntitiy = ((CraftEntity) entity).getHandle();
    ...
    public static boolean existsPath(Entity aEntity, BlockPosition aDest, boolean f0, boolean f1, boolean f2, boolean f3) {
        net.minecraft.server.v1_6_R2.Entity lMCEntitiy = ((CraftEntity) aEntity).getHandle();
