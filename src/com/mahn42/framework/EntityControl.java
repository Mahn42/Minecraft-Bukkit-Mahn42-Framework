...
public class EntityControl {
    ...
    public void run() {
        ...
        if (pathItem != null) {
            ...
            if (pathItem != null && lDest != null) {
                net.minecraft.server.v1_6_R3.Entity lMCEntitiy = ((CraftEntity) entity).getHandle();
                if (lMCEntitiy instanceof EntityCreature) {
                     ...
                     */
                    EntityPlayerNPC lPlayer = (EntityPlayerNPC) lMCEntitiy;
                    ...
                    if (lastLocation != null && lastPathPoint != null && lastTarget != null && lastTarget.equals(lDest)) {
                        ...
                        if (distanceSquared > 0.5) {
                            PathEntity d = lNavigation.e();// lNavigation.d();
                            if (d != null) {
                                PathPoint c = d.c();
                                if (c != null) {
    ...
    public static boolean existsPath(Entity aEntity, BlockPosition aDest, boolean f0, boolean f1, boolean f2, boolean f3) {
        net.minecraft.server.v1_6_R3.Entity lMCEntitiy = ((CraftEntity) aEntity).getHandle();
